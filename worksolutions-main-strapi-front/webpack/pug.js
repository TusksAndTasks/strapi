...
const addDirListener = () => {
  ...
  compilePugFile("outstaffing-strapi", "outstaffing-strapi");
  compilePugFile("outstaffing-typescript", 'outstaffing-typescript')
  compilePugFile("outstaffing-javascript", 'outstaffing-javascript')
  ...
  compilePugFile("tehnicheskiy-audit-web-proektov", 'tehnicheskiy-audit-web-proektov')
