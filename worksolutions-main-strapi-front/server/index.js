...
const {getReviews, getTitleData, getEmail, getLogo, getPartners, getAbout, getFeatures, getTechnologies, getTeam,
  getDevs
} = require("./api/indexPage");
...
makeRoute(app, ["/tehnicheskiy-audit-web-proektov", "/tehnicheskiy-audit-web-proektov.html"], {fileName: "tehnicheskiy-audit-web-proektov.html"});
...
app.use('/title-api', getTitleData);
app.use('/email-api', getEmail);
app.use('/logo-api', getLogo);
app.use('/partners-api', getPartners);
app.use('/data-numbers-api', getAbout);
app.use('/features-api', getFeatures);
app.use('/tech-api', getTechnologies);
app.use('/team-api', getTeam);
app.use('/devs-api', getDevs);
app.use("/reviews-api", getReviews);
